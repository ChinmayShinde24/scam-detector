    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl w-full max-w-md p-8 border border-white/20">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300" style={{ fontFamily: 'Roboto, sans-serif' }}>Sign in to protect yourself from scams</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-300">
            ...
            <Link to="/register" className="text-gray-400 hover:text-gray-300 font-medium transition-colors">
              Sign up
            </Link>
          </p>
        </div>
